...
def test_get_feed(utils, httpx_mock):
    ...
    httpx_mock.add_response(
        ...
        url=expected_url,
        status_code=200,
        content=utils.get_fixture("ivoox.html"),
    )
