...
def test_get_feed(utils):
    ...
    assert episode.url == f'{base_url}download?s=ivoox&id=ck-227-navidades-infernales-de-black-christmas-a-krampus-audios-mp3_rf_79593896_1'
